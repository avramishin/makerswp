                        ...
                        <li>
                            <div class="table">
                                <div class="table-cell">
                                    <img width="210" height="74"
                                         src="http://negoto.tvatteriet.se/wp-content/uploads/2015/09/cashboard-210x74.png"
                                         class="attachment-company-logo wp-post-image" alt="cashboard"/>
