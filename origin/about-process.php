    ...
    <div class="sub-navigation-inner">
      <nav>
        <ul class="sub-navigation-menu">
          ...
          <li class="active"><a href="about-process.php">Process</a></li>
        </ul>
      </nav>
  ...
  <div id="identify" class="grid process">
    <div class="process-identify grid-item-wide">
      ...
      <div class="process-content">
        ...
        <p>Did you know that most startups fail during the first six months? The main obstacles here include ineffecient teams, a lack of resources or failure to identify product-market fit. While success/failure of startups is oftentimes beyond our control, we believe the chances of failure should not be a stumbling block that constrains an entrepreneur’s imagination. Instead, we see it as a stepping stone to success.
        <br>
        <br>
